...
d3.csv("covid.csv").then(data => { //.then - a promis, controlling what JS is going to 

    for (let d of data) {
        d.cases = +d.cases; //force a number
    };

    //data.sort((a, b) => b.cases - a.cases); // JS convention for sorting + sorting so larger numbers on the top
